...
class _FormularioState extends State<Formulario> {
  ...
  File? _imagen;
  bool _isCameraOverlayVisible = false;
  final picker = ImagePicker();

  void _toggleCameraOverlay() {
    setState(() {
      _isCameraOverlayVisible = !_isCameraOverlayVisible;
    });
  }
          ...
          child: Form(
            ...
            child: ListView(
              children: <Widget>[
                ...
                SizedBox(height: 40),
                ElevatedButton(onPressed: _toggleCameraOverlay, child: Text('Tomar Foto')),
                if (_imagen != null)
                  Image.file(
                    _imagen!,
                    width: 150,
